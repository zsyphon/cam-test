...
import com.cam.integration.dto.common.Location;
import com.fasterxml.jackson.annotation.JsonCreator;
import com.fasterxml.jackson.annotation.JsonInclude;
import com.fasterxml.jackson.annotation.JsonInclude.Include;
import com.fasterxml.jackson.annotation.JsonProperty;

public class SFLocation extends AbstractSObjectBase implements Serializable {

	private static final long serialVersionUID = -5473836502431566077L;
	...
	public SFLocation(Location location) {
		...
		this.camIntegartionId = location.getcamIntegartionId();
		this.idType = location.getIdType();
		this.primaryLocationFlag =location.getPrimaryLocationFlag();
...
//		this.setLongitude(longitude);
	...
	@JsonCreator
	public SFLocation(@JsonProperty("locationId") String locationId, @JsonProperty("camIntegartionId") int camIntegrationId, @JsonProperty("idType") String idType,
